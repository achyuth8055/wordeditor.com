...
import { Summarizer as SummarizerComponent } from './Summarizer';
...
export const SummarizerPage: React.FC = () => {
  ...
  useEffect(() => {
    const saved = localStorage.getItem('summarizer-text');
    if (saved) setText(saved);
  }, []);

  // Save to localStorage on change
  useEffect(() => {
    localStorage.setItem('summarizer-text', text);
  }, [text]);
