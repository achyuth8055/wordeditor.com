    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 flex items-center justify-center px-4 py-16 sm:px-6 sm:py-24 md:grid-cols-2 lg:px-8">
      <div className="max-w-md w-full space-y-8 bg-white p-10 rounded-xl shadow-2xl">
        <div className="text-center">
          ...
          <h1 className="mt-6 text-3xl font-extrabold text-gray-900 sm:text-4xl">Something went wrong!</h1>
          <p className="mt-2 text-base text-gray-500">We&apos;re sorry, we encountered an issue. Please try again later.</p>
        </div>
        <div className="mt-8">
          <button
            onClick={reset}
