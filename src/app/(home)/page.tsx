    ...
    <div className="min-h-screen flex flex-col bg-white">
      ...
      <div className="mt-16 flex-1">
        ...
        <div className="relative bg-gradient-to-br from-emerald-50 via-white to-blue-50 overflow-hidden">
          ...
          <div className="max-w-screen-xl mx-auto px-6 py-20 text-center relative z-10">
            <div className="animate-fade-in-up">
              ...
              <div className="flex gap-4 justify-center flex-wrap">
                ...
                <Link href="/documents">
                  <button className="bg-white hover:bg-gray-50 text-gray-900 px-8 py-4 rounded-xl font-semibold text-lg border-2 border-gray-200 hover:border-emerald-400 shadow-md hover:shadow-lg transition-all transform hover:scale-105">
                    Create Document
                  </button>
                </Link>
              </div>
            ...
            <div className="mt-16 animate-fade-in" style={{animationDelay: '0.3s'}}>
              <div className="relative rounded-2xl overflow-hidden shadow-2xl border-4 border-white max-w-5xl mx-auto">
                <img 
                  src="https://images.unsplash.com/photo-1551288049-bebda4e38f71?w=1200&h=600&fit=crop" 
                  alt="Text editing workspace"
            ...
            {tools.map((tool, index) => {
              ...
              return (
                <Link
                  ...
                  href={tool.href}
                  {...linkProps}
                  className="group bg-white rounded-xl border-2 border-gray-200 p-6 hover:shadow-2xl hover:border-emerald-400 transition-all duration-300 transform hover:-translate-y-2"
        ...
        <div className="bg-gray-50 py-16">
          <div className="max-w-screen-xl mx-auto px-6">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <div className="bg-white p-8 rounded-xl shadow-sm hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-100">
                <div className="w-12 h-12 bg-gradient-to-br from-emerald-400 to-emerald-600 rounded-lg flex items-center justify-center mb-4 shadow-lg">
        ...
        <div className="max-w-screen-xl mx-auto px-6 py-16">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            <div className="text-center p-6 bg-white rounded-xl hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-100">
              ...
              <h3 className="font-bold text-lg mb-2">Students & Writers</h3>
              <p className="text-sm text-gray-600">Meet essay requirements, track word counts, and improve writing quality</p>
            </div>
            <div className="text-center p-6 bg-white rounded-xl hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-100">
              ...
              <p className="text-sm text-gray-600">Optimize SEO content, analyze keyword density, and check readability scores</p>
            </div>
            <div className="text-center p-6 bg-white rounded-xl hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-100">
              ...
              <p className="text-sm text-gray-600">Convert text cases, compare code, preview Markdown, and format text</p>
            </div>
            <div className="text-center p-6 bg-white rounded-xl hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-100">
              ...
              <h3 className="font-bold text-lg mb-2">Public Speakers</h3>
              <p className="text-sm text-gray-600">Calculate speaking time, practice with typing test, and prepare presentations</p>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-screen-xl mx-auto px-6 py-16">
          <div className="text-center mb-12">
            <h2 className="text-3xl sm:text-4xl font-bold text-gray-900 mb-4">Latest from Our Blog</h2>
            <p className="text-lg text-gray-600">Expert tips, guides, and insights to improve your writing and productivity</p>
          </div>
          <div className="grid md:grid-cols-2 gap-8">
            {blogPosts.map((post, index) => (
              <div key={index} className="group bg-white border-2 border-gray-200 rounded-xl overflow-hidden hover:shadow-xl hover:border-emerald-400 transition-all duration-300 transform hover:-translate-y-1">
        ...
        {/* CTA Section */}
        <div className="relative bg-gradient-to-r from-emerald-600 to-blue-600 py-20 overflow-hidden">
          <div className="absolute inset-0 opacity-10">
