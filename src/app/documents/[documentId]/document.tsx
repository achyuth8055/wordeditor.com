...
export const Document = ({ preloadedDocument }: DocumentProps) => {
  /**
   * When deleting a document while on the /documents/ path, database updates
   * trigger Convex to refetch document info, causing API errors that trigger
   * error boundaries. We handle this in the client component by redirecting
   * to / when the document doesn't exist.
   */
  try {
